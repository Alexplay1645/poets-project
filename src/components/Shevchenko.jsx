...
function Shevchenko() {
  return (
    <div className="bio-container">
      <img src="/Authors/Shevchenko.jpg" alt="Тарас Шевченко" className="portrait"/>
      ...
      <p className="subtitle">
            ...
            {TarasBooks.books.map(book => (
            <Link key={book.id} to={`/poet/Shevchenko/book/${book.id}`} className="book-card">
